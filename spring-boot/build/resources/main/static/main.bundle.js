...
var ROUTES = [
    ...
    { path: 'editusers', component: __WEBPACK_IMPORTED_MODULE_10__pages_user_edit_page_user_edit_page_component__["a" /* UserEditPageComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_19__common_auth_service__["a" /* AuthService */]], },
    ...
    { path: 'users', component: __WEBPACK_IMPORTED_MODULE_9__pages_user_list_page_user_list_page_component__["a" /* UserListPageComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_19__common_auth_service__["a" /* AuthService */]], },
...
var SignInPageComponent = (function () {
    function SignInPageComponent(formBuilder, userService, router) {
        this.formBuilder = formBuilder;
        this.userService = userService;
        this.router = router;
        this.signInForm = new __WEBPACK_IMPORTED_MODULE_2__angular_forms__["f" /* FormGroup */]({
            username: new __WEBPACK_IMPORTED_MODULE_2__angular_forms__["g" /* FormControl */](),
            password: new __WEBPACK_IMPORTED_MODULE_2__angular_forms__["g" /* FormControl */]()
        });
    }
...
SignInPageComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_2__angular_forms__["e" /* FormBuilder */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__angular_forms__["e" /* FormBuilder */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1__services_user_service__["a" /* UserService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__services_user_service__["a" /* UserService */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_3__angular_router__["b" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__angular_router__["b" /* Router */]) === "function" && _c || Object])
], SignInPageComponent);
...
var UserEditPageComponent = (function () {
    ...
    UserEditPageComponent.prototype.onSubmit = function () {
        var _this = this;
        this.userService.create(this.userForm.get('username').value, this.userForm.get('email').value, this.userForm.get('password').value, this.userForm.get('firstname').value, this.userForm.get('lastname').value, this.userForm.get('image').value).subscribe(function (response) {
...
var UserService = (function (_super) {
    ...
    function UserService(config, http, authService) {
        ...
        _this.authService = authService;
        _this.users = [
            new __WEBPACK_IMPORTED_MODULE_1__models_user__["a" /* User */]("", "", "", "Alejandro", "Villarraga", "https://scontent.fbog2-1.fna.fbcdn.net/v/t1.0-1/p160x160/15590330_1889204337980981_7135372285958833797_n.jpg?oh=e9a8ee54c5fd489d7f73dfea9025d662&oe=5B1D4B56"),
            new __WEBPACK_IMPORTED_MODULE_1__models_user__["a" /* User */]("", "", "", 'Javier', "Silva", "https://scontent.fbog2-1.fna.fbcdn.net/v/t1.0-1/p160x160/17904011_10211686718499558_4641406048506891513_n.jpg?oh=d4fd6f460a6a82ac17381b686e970a4f&oe=5B07B65E")
        ];
    ...
    UserService.prototype.create = function (username, password, email, firstname, lastName, image) {
        return this.post(this.resourceUrl, new __WEBPACK_IMPORTED_MODULE_1__models_user__["a" /* User */](username, password, email, firstname, lastName, image));
    };
...
UserService = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["c" /* Injectable */])(),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_5__common_config_app_configuration_service__["a" /* AppConfiguration */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_5__common_config_app_configuration_service__["a" /* AppConfiguration */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_3__angular_http__["b" /* Http */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__angular_http__["b" /* Http */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_6__common_auth_service__["a" /* AuthService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_6__common_auth_service__["a" /* AuthService */]) === "function" && _c || Object])
], UserService);
